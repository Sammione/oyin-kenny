  ...
  return (
    <div className="min-h-screen bg-stone-50 font-sans text-stone-800">
      ...
      <section className="relative min-h-screen flex flex-col items-center text-center overflow-hidden pt-12 pb-24">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 w-full justify-center px-4">
            <a href="/rsvp" className="w-full sm:w-auto text-center bg-[#556B2F] hover:bg-[#37461E] text-white px-8 py-4 rounded-full text-lg font-bold transition-all shadow-xl transform hover:-translate-y-1">
              RSVP Now
            </a>
      ...
      <footer className="bg-[#37461E] text-white py-16 text-center">
        ...
        <a href="/rsvp" className="inline-block bg-white text-[#37461E] px-8 py-3 rounded-full font-bold hover:bg-stone-200 transition-colors">
