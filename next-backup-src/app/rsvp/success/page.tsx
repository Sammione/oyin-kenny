  ...
  if (!token) {
    return (
      <div className="text-center p-8">
        ...
        <Link href="/" className="text-[#CC5500] hover:underline mt-4 inline-block">Return home</Link>
      </div>
    )
  }
  ...
  if (!attending) {
    return (
      ...
      >
        ...
        <Link href="/" className="inline-flex items-center text-[#556B2F] hover:text-[#37461E] font-medium">
    ...
    <>
      ...
      <div className="fixed -left-[9999px] top-0">
        <div ref={ivCardRef} className="w-[800px] bg-white text-center flex flex-col items-center justify-center relative overflow-hidden" style={{ height: '1200px' }}>
          ...
          <img src="/images/DSC_1918-Edit.jpg" alt="Couple" className="absolute bottom-0 left-0 w-full h-[500px] object-cover opacity-60 mix-blend-overlay" />
        </div>
      </div>
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <div className="pt-2 flex justify-center space-x-4">
            <Link href="/" className="inline-flex items-center px-6 py-3 rounded-xl border-2 border-[#556B2F] text-[#556B2F] font-semibold hover:bg-[#556B2F] hover:text-white transition-colors">
  ...
  return (
    <div className="min-h-screen bg-stone-50 py-12 px-4 flex flex-col justify-center">
      <div className="max-w-md w-full mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border-t-8 border-[#556B2F]">
        <Suspense fallback={<div className="p-12 text-center text-stone-500">Loading your pass...</div>}>
          <SuccessContent />
        </Suspense>
      </div>
    </div>
